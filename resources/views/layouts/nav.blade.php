...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="{{ url('/admin') }}">Prensa</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Prensa">
                ...
                <ul class="sidenav-second-level collapse" id="collapsePrensa">
                    <li>
                        <a href="{{ action('UsuarioController@create') }}">
                            <i class="fa fa-fw fa-table"></i> Alta usuario
                        </a>
                    </li>
                    <li>
                        <a href="{{ action('UsuarioController@list') }}">
                            <i class="fa fa-fw fa-table"></i> Listado de usuarios
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/importExport') }}">
                            <i class="fa fa-fw fa-table"></i> Importar y exportar
                        </a>
                    </li>
                </ul>
            </li>            
